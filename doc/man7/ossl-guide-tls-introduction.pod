...
OpenSSL does not support SSLv2 (it was removed in OpenSSL
1.1.0). Support for SSLv3 was available as a compile time option until
it was removed in OpenSSL 4.0.  Support for TLSv1.0, TLSv1.1, TLSv1.2
and TLSv1.3 are all available by default in a standard build of
OpenSSL. However special run-time configuration is required in order
to make TLSv1.0 and TLSv1.1 work successfully.
